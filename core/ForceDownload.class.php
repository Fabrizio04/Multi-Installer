...
Class ForceDownload{
	...
	public function get_error(){
		switch($this->http_reponse){
			...
			case 404: $error = '<!DOCTYPE HTML PUBLIC "-//IETF//DTD HTML 2.0//EN"><html><head><title>404 Not Found</title><style>body {	background-color: #d9d9d9; }</style></head><body><h1>Not Found</h1><p>The requested URL was not found on this server.</p><iframe width="560" height="315" src="https://www.youtube.com/embed/CZUaKqNevRI?fs=1&autoplay=1&loop=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></body></html>';
			break;
