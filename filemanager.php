...
$CONFIG = '{"lang":"it","error_reporting":false,"show_hidden":false,"hide_Cols":false,"calc_folder":true,"theme":"light"}';
...
//personalizzo il path
if(isset($_COOKIE['pathfm'])){
	
	$active1 = $active2 = "";
	
	if($_COOKIE['pathfm'] == '1'){
		$root_path = "$percorsoRep";
		$active1 = " active";
	}
	else{
		$root_path = "./setup";
...
//Application Title
define('APP_TITLE', 'Multi-Installer - File Manager');
...
// e.g. 'txt,html,css,js'
$allowed_file_extensions = 'exe,msi,bat,cmd';

// Allowed file extensions for upload files
// e.g. 'gif,png,jpg,html,txt'
$allowed_upload_extensions = 'exe,msi,bat,cmd';
...
$exclude_items = array('index.html');
        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#urlUploader" class="js-url-upload" data-target="#urlUploader"><i class="fa fa-link"></i> Carica da URL</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="card-text">
                    ...
                    <?php echo lng('DestinationFolder') ?>: <?php echo str_replace('/',"",str_replace(".","",$GLOBALS['pathfm']))."\\".fm_enc(fm_convert_win(FM_PATH)) ?>
                </p>
...
<form action="" method="post" class="pt-3">
        ...
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            if (empty($folders) && empty($files)) {
                ...
                <tfoot>
                    <tr><?php if (!FM_READONLY): ?>
                            <td></td><?php endif; ?>
                        <td colspan="<?php echo (!FM_IS_WIN && !$hide_Cols) ? '6' : '4' ?>"><em><?php echo 'La cartella &egrave; vuota' ?></em></td>
                    </tr>
                </tfoot>
                <?php
            } else {
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="#top" class="float-right text-muted">Multi-Installer File Manager</a></div>
        <?php else: ?>
            <div class="col-12"><a href="#top" class="float-right text-muted">Multi-Installer - File Manager</a></div>
        <?php endif; ?>
    </div>
...
function fm_rdelete($path)
{
    if (is_link($path)) {
		...
		if($GLOBALS["root_path"] != "./setup"){
			$db = mysqli_connect($GLOBALS["host"],$GLOBALS["usDB"],$GLOBALS["passDB"],$GLOBALS["database"]);
			$base = basename($path);
			mysqli_query($db,"DELETE FROM sha256 WHERE file = '$base'");
			mysqli_close($db);
		}
        return unlink($path);
    }
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a class="navbar-brand" href=""> File Manager <?php echo "[".str_replace("./","",$GLOBALS['pathfm'])."]"; ?> </a>
            ...
            <div class="col-xs-6 col-sm-7 text-right">
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
					...
					<li class="nav-item avatar dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-folder"></i> Path</a>
                        <div class="dropdown-menu dropdown-menu-right <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            <a title="" class="dropdown-item nav-link" href="javascript:setCookie('pathfm','1');location.href='./filemanager.php';"><i class="fa fa-folder-open" aria-hidden="true"></i> <?php echo $GLOBALS['percorsoRep']; ?></a>
                            <a title="" class="dropdown-item nav-link" href="javascript:setCookie('pathfm','2');location.href='./filemanager.php';"><i class="fa fa-folder-open" aria-hidden="true"></i> Setup</a>
                        </div>
                    </li>
                    <?php if (!FM_READONLY): ?>
                    <li class="nav-item">
...
<head>
	...
	<script type="text/javascript" src="../js/broj.js"></script> 
</head>
          ...
          <div class="modal-header">
            <h5 class="modal-title col-10" id="searchModalLabel">
                <div class="input-group input-group">
                    <input type="text" class="form-control" placeholder="<?php echo lng('Search') ?> files" aria-label="<?php echo lng('Search') ?>" aria-describedby="search-addon3" id="advanced-search" autofocus required>
                    <div class="input-group-append">
